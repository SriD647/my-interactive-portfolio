...
const Home = () => {
  ...
  return (
    <div className='md:px-10  px-7 my-10 bg-[#1a1a29]'>
      <div className='flex flex-col pl-20 lg:flex-row w-auto justify-center items-center'> {/* Added justify-center and items-center */}
        <div className='lg:w-1/2 text-center'> {/* Added text-center */}
          <div className='text-white relative pl-10'>
            ...
            <h3 className='font-semibold text-left ld:w-96 text-2xl mb-2 w-full'>I am a passionate software professional based in Toronto, Canada. I am open to remote work and opportunities abroad. </h3>
        ...
        <div className="lg:w-1/2 items-right lg:order-last md:pl-20   md:order-last -mt-1">
